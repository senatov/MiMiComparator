...
internal fun MainController.configurePreviewSettingsMenu() {
    previewSettingsBtn.installStandardHelp("Diff viewer settings")
    sideBySideViewToggle.installStandardHelp("Side-by-side viewer")
    unifiedViewToggle.installStandardHelp("Unified viewer is not available yet")
