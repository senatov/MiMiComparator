...
internal fun toolbarIconSpec(sourceIcon: String, helpText: String): ToolbarIconSpec {
    ...
    return when {
        "previous difference" in help -> ToolbarIconSpec("↑", "#64748b", 21)
        "next difference" in help -> ToolbarIconSpec("↓", "#64748b", 21)
        "edit comparison" in help -> ToolbarIconSpec("✎", "#7b8490", 20)
        "compare previous file" in help -> ToolbarIconSpec("←", "#708090", 22)
        "compare next file" in help -> ToolbarIconSpec("→", "#708090", 22)
        "copy content to right" in help -> ToolbarIconSpec("→", "#2380df", 23)
        "copy content to left" in help -> ToolbarIconSpec("←", "#279253", 23)
